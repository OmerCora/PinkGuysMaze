...
{
	this->lightInfo.diffuse = glm::vec3(this->lightInfo.diffuse.x, this->lightInfo.diffuse.y, this->lightInfo.diffuse.z);
	//check sound
...
std::string cLightSource::GetObjectName(void)
{
	return this->objectName;
}

void cLightSource::SetObjectName(std::string name)
{
