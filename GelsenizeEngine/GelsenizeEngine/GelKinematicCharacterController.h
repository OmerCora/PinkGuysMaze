...
//Thanks Ocelot: http://bulletphysics.org/Bullet/phpBB3/viewtopic.php?f=9&t=5684
...
namespace OiJE {
	...
	class GelKinematicCharacterController : public btCharacterControllerInterface
	{
	protected:
	...
	public:
		GelKinematicCharacterController(btPairCachingGhostObject* ghostObject, btConvexShape* convexShape, btScalar stepHeight, int upAxis = 1);
		~GelKinematicCharacterController();
		...
		bool onGround() const { return (m_verticalVelocity >= -1.0f || m_verticalVelocity <= 0.0f) && fabs(m_verticalOffset) <= 0.05f; }

		iGameObject* characterOwner;
	};
	//---------------------------------------------------------------------------------------
